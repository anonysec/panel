...
const protocols = [
  { key: 'openvpn', name: 'OpenVPN', icon: 'ðŸ”', defaultPort: 1194, defaultNetwork: '10.8.0.0/20' },
  { key: 'wireguard', name: 'WireGuard', icon: 'ðŸ›¡ï¸', defaultPort: 51820, defaultNetwork: '10.66.0.0/20' },
  { key: 'l2tp', name: 'L2TP/IPsec', icon: 'ðŸ”—', defaultPort: 1701, defaultNetwork: '10.9.0.0/20' },
  { key: 'ikev2', name: 'IKEv2', icon: 'ðŸ”‘', defaultPort: 500, defaultNetwork: '10.10.0.0/20' },
  { key: 'ssh', name: 'SSH Tunnel', icon: 'ðŸ’»', defaultPort: 2222, defaultNetwork: '' },
] as const
...
const protocolFields: Record<string, FieldDef[]> = {
  openvpn: [
    ...
    { key: 'auth_mode', label: 'services.auth_mode', type: 'select', default: 'hybrid', options: [
    ...
    { key: 'backup_domain', label: 'services.backup_domain', type: 'text', default: '',
...
const panelTitle = computed(() => {
  ...
  return proto && node ? `${proto.name} â€” ${node.node.name}` : ''
})
